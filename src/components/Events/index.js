...
class Event extends Component {
  state = {registrationStatus: allStatusList.initial}

  changeTheState = state => {
  ...
  render() {
    ...
    return (
      <div className="outerEvent">
        {/* first div */}
        <div className="firstEventChild">
          <h1 className="mainHeading">Events</h1>
          <ul className="firstEventChildInner">
        ...
        {/* first div ended */}
        {/* second div */}
        <div className="secondEventChild">
